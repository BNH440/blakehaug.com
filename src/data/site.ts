...
export const siteConfig = {
   ...
   */
  description:
    "I'm a 3rd year EECS student at UC Berkeley, " +
    "currently focused on infrastructure as code and systems programming. " +
    "I'm also interested in programming mobile apps, automation scripts, robots, and more!",
